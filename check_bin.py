...
def run_remote_command(cmd, timeout=30):
    ...
    child.timeout = timeout # Set expect timeout
...
print("--- Checking Bin ---")
run_remote_command("ls -la ngfit-pro-clean/node_modules/.bin")
run_remote_command("ls -la ngfit-pro-clean/node_modules/vite/bin")
